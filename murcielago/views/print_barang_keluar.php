...
<img src="<?php echo base_url() ?>assets/img/logo/logo-stikes3.png" width="250px">
    <br>
<?php $data['laporan_penjualan'] = $this->m_data->laporan_penjualan($this->uri->segment(3),$this->uri->segment(4))->result_array(); ?>
    <br>
    <br>
    <h3 class="text-center">Barang Keluar Mulai tanggal 

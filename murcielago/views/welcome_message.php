...
<body>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>assets_kasir/ajaxcomplete/scripts/jquery-1.8.2.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>assets_kasir/ajaxcomplete/scripts/jquery.mockjax.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>assets_kasir/ajaxcomplete/src/jquery.autocomplete.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>assets_kasir/ajaxcomplete/scripts/countries.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>assets_kasir/ajaxcomplete/scripts/demo.js"></script>
</body>
</html>

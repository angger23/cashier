...
<img src="<?php echo base_url() ?>assets/img/logo/logo-stikes3.png" width="250px">
    <h2 class="text-center">Laporan Kas Masuk</h2>
<h3 class="text-center">Mulai tanggal 
    <?php echo date("d-m-Y",strtotime($this->uri->segment(3))) ?>
    Sampai <?php echo date("d-m-Y",strtotime($this->uri->segment(4))) ?></h3>
    <br>
    <div class="row">
        <div class="container">
            <table class="table table-responsive table-bordered">
                ...
                <tbody>
                    <?php       
                    $noz = 0; 
                    $data['kas_masuk'] = $this->m_data->kas_masuk($this->uri->segment(3),$this->uri->segment(4))->result_array();
                        foreach($data['kas_masuk'] as $record ){  
                    ...
                    <?php } ?> 
                    <tr>
                 <?php $data['totalnya'] = $this->m_data->sum_total_debet($this->uri->segment(3),$this->uri->segment(4))->row(); ?>

...
<img src="<?php echo base_url() ?>assets/img/logo/logo-stikes3.png" width="250px">
    <h2 class="text-center">Laporan Kas Keluar</h2>
<h3 class="text-center">Mulai tanggal <?php echo date("d-m-Y",strtotime($this->uri->segment(3))) ?>
        sampai <?php echo date("d-m-Y",strtotime($this->uri->segment(4))) ?>
    </h3>
    <br>
    <div class="row">
        <div class="container">
            <table class="table table-responsive table-bordered">
                ...
                <tbody>
                    <?php       
                    $noz = 0; 
                    $data['kas_keluar'] = $this->m_data->kas_keluar($this->uri->segment(3),$this->uri->segment(4))->result_array();
                        foreach($data['kas_keluar'] as $record ){  
                    ...
                    <?php } ?> 
                    <tr>
                 <?php $data['totalnya'] = $this->m_data->sum_total_kredit($this->uri->segment(3))->row(); ?>

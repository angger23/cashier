                   ...
                   <table class="table table-bordered table-striped datatable">
                    ...
                    foreach($posts as $l){
                      ...
                      <?php }else{
                        $deb=$l->debit;
                        ?>
                        <td>Rp. <a href="javascript:void(0)" data-toggle="modal" data-target="#myModalxa<?php echo $no ?>"><?= number_format($l->debit,2) ?></a></td>
                      <?php } ?>
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <?php }else{ ?>
                                <form action="<?php echo base_url('buku_umum/add_hikt') ?>" method="post">

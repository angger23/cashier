...
<div class="col-md-12">
  <?
    if(!empty($tgl)){
    ?>
    <a href="<?= base_url('bank_buku/cetak_buku1/'.$tgl.'/'.$tgl1.'/'.$id.'/SBBBKT/kurang') ?>" target="_blank" class="btn btn-info btn-flat pull-right" type="button"><i class="fa fa-print"></i> Print</a>
    <? }else{ ?>
    <a href="<?= base_url('bank_buku/cetak_buku1/0/0/0/SBBBKT/kurang') ?>" target="_blank" class="btn btn-info btn-flat pull-right" type="button" style="margin:5px;"><i class="fa fa-print"></i> Print</a>
    <? } ?>
    <?
    if(!empty($tgl)){
    ?>
    <a href="<?= base_url('bank_buku/export_buku1/'.$tgl.'/'.$tgl1.'/'.$id.'/SBBBKT/kurang') ?>" class="btn btn-success btn-flat pull-right"><i class="fa fa-file-excel-o"></i> Export</a>
    <? }else{ ?>
    <a href="<?= base_url('bank_buku/export_buku1/0/0/0/SBBBKT/kurang') ?>" class="btn btn-success btn-flat pull-right" style="margin:5px;"><i class="fa fa-file-excel-o"></i> Export</a>
    <? } ?>
...
<?php } ?>
 <div class="col-md-12">
    <p style="padding:5px 10px;background-color:#ffbe76;"><b>Saldo</b> : <b>Rp. <?= number_format($sal); ?></b></p>
 </div>
  ...
  <table class="table table-bordered">
    <tbody>
      <tr style="background-color:#e74c3c;color:#ffff;">
        ...
        <td colspan="3">Saldo : Rp <?= number_format($sal) ?></td>
      </tr>
    </tbody>
  </table>
<!-- wates -->

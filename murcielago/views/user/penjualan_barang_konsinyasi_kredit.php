...
<div class="main" style="padding-bottom: 100px;">
	<div class="main-inner">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
                    <h3 style="margin: 0px;" class="pull-left"><b><i class="fa fa-stock"></i>&nbsp;&nbsp;Penjualan Barang Konsinyasi Kredit - Laporan Laba Rugi</b></h3>
                </div>
            </div>  
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="padding:0px;">
                    <div class="col-md-6">
                        <div class="form-group" style="margin-top:24px;">
                            ...
                            <? if(empty($this->input->post('hari1'))){ ?>
                                <a href="<?= base_url('penjualan_barang_konsinyasi/export_kredit') ?>" class="btn btn-primary btn-flat btn-block pull-right"><i class="fa fa-file-excel-o"></i> Export</a>
                            <? }else{  ?>
                              <a href="<?= base_url('penjualan_barang_konsinyasi/export_kredit/') ?><?= $this->input->post('hari1') ?>/<?= $this->input->post('hari2') ?>/<?= $this->input->post('op') ?>" target="_blank" class="btn btn-primary btn-flat btn-block pull-right"><i class="fa fa-file-excel-o"></i> Export</a> 
                            <? } ?>
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group" style="margin-top:24px;">
                            <? if(empty($this->input->post('hari1'))){ ?>
                                <a href="<?= base_url('penjualan_barang_konsinyasi/print_kredit') ?>" target="_blank" class="btn btn-warning btn-flat btn-block pull-right"><i class="fa fa-print"></i> Print</a>
                            <? }else{  ?>
                              <a href="<?= base_url('penjualan_barang_konsinyasi/print_kredit/') ?><?= $this->input->post('hari1') ?>/<?= $this->input->post('hari2') ?>/<?= $this->input->post('op') ?>" target="_blank" class="btn btn-warning btn-flat btn-block pull-right"><i class="fa fa-print"></i> Print</a> 
                            <? } ?>
                        </div>
                    </div>
                </div> 
            ...
            <div class="row">
                ...
                <? 
                  ...
                  $total1 = 0;
                  $total2 = 0;
                  foreach($konsinyasi_kredit as $p):
                  $nos++;
                ...
                <? if(empty($this->input->post('hari1'))){ ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered datatable-biasa">
                            ...
                            <tbody>
                                <? $no = 0; foreach($konsinyasi_kredit as $p){ $no++; ?>
                                  <tr>
                                    <td><?= $no ?></td>
                ...
                <? }else{ ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered datatable-biasa">
                            ...
                            <tbody>
                                <?
                                    $konsinyasi_kredit = $this->m_data->cari_penjualan_barang_konsinyasi_kredit($har1,$har2)->result();
                                    $no = 0; foreach($konsinyasi_kredit as $p){ $no++; 
                                ?>
                                  <tr>
                                    <td><?= $no ?></td>

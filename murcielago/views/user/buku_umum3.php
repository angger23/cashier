...
<div class="content-wrapper">
 <div class="container-fluid">
   ...
   <div class="row">
       <div class="col-md-10">
         <h4><b>Data Buku Kas Umum Toko </b></h4>
       </div>
       <div class="col-md-2">
         <button type="button" class="btn btn-primary btn-flat pull-right" data-toggle="modal" data-target="#myModal" style="margin:5px;"><i class="fa fa-plus"></i> Input Buku Umum Toko</button>
         <!-- Modal -->
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    <form action="<?php echo base_url('buku_umum/add_buku_umum') ?>" method="post">
                      <div class="form-group">
...
<script>
    function searchFilter(page_num) {
      ...
      $.ajax({
      type: 'POST',
      url: '<?php echo base_url(); ?>buku_umum/ajaxPaginationData1/'+page_num,
                      ...
                      <form class="" action="<?//= base_url('user/index/ac') ?>" method="post">
                        ...
                        <div class="col-md-4">
                         ...
                         <select class="form-control selectku" name="" id="filter" onchange="searchFilter()">
                           ...
                           $kas_anggota_list = $this->m_data->where('kode_transaksi',array('status' => 'Kas Toko'))->result();
                 ...
                 <script type="text/javascript">
                   function ome(){
                    ...
                    if($this->uri->segment('3') == 'ac'){ ?>
                      $("#loadx").load("<?php echo base_url("buku_umum/search_buku_umum/") ?>"+'<?php echo $this->input->post('start_tgl') ?>'+'/<?php echo $this->input->post('end_tgl') ?>/'+'/'+$("#okeex").val()+'/<?php echo $this->input->post('operator') ?>');
                    <?php }else{ ?>
                      $("#loadx").load("<?php echo base_url('buku_umum/search_buku_umum/0/0/') ?>" + $("#okeex").val()+'/'+'0/');
                    <?php } ?>
                   }
                 </script>
       <?php
       // echo $this->input->ip_address();
       //  if($this->input->ip_address() == '1.1.1.1'){
        ?>
        <!-- <div class="col-md-12">
          <hr>
            <div class="alert alert-danger">
              <b>Maaf Sedang dalam perbaikan untuk melihat data , anda masih dapat menambahkan data ke kas umum toko.</b>
            </div>
        </div> -->
      <?php //}else{ ?>
       <div class="col-md-12">

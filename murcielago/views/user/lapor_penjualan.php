...
<div class="panel panel-default">
    <div class="panel-heading"><h5 style="padding:0;">Kirim Data Penjualan Ke Database Online</h5></div>
    <div class="panel-body">
        <form method="post" action="<?php echo base_url() ?>online">
        ...
        <table class="table data" id="example">
                        ...
                        <tbody>
                            <?php $data['antara'] = $this->m_data->barang_satu_tgl($this->input->post('tgl'))->result_array(); ?>
...
<div id="myModal<?php echo $no; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="panel-footer" style="padding:0;">
        <h3><a href="<?php echo base_url() ?>online/kirim_penjualan/<?php echo $this->input->post('tgl') ?> " class="btn btn-success" style="margin-bottom:10px;">Kirim</a></h3>
    </div>
    <?php }else{ ?>

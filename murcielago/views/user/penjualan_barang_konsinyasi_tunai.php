...
<div class="main" style="padding-bottom: 100px;">
	<div class="main-inner">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
                    <h3 style="margin: 0px;" class="pull-left"><b><i class="fa fa-stock"></i>&nbsp;&nbsp;Penjualan Barang Konsinyasi Tunai - Laporan Laba Rugi</b></h3>
                </div>
            </div>  
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-4" style="padding:0px;">
                    <div class="col-md-6">
                        <div class="form-group" style="margin-top:24px;">
                            ...
                            <? if(empty($this->input->post('hari1'))){ ?>
                                <a href="<?= base_url('penjualan_barang_konsinyasi/export_tunai') ?>" class="btn btn-primary btn-flat btn-block pull-right"><i class="fa fa-file-excel-o"></i> Export</a>
                            <? }else{  ?>
                              <a href="<?= base_url('penjualan_barang_konsinyasi/export_tunai/') ?><?= $this->input->post('hari1') ?>/<?= $this->input->post('hari2') ?>/<?= $this->input->post('op') ?>" target="_blank" class="btn btn-primary btn-flat btn-block pull-right"><i class="fa fa-file-excel-o"></i> Export</a> 
                            <? } ?>
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group" style="margin-top:24px;">
                            <? if(empty($this->input->post('hari1'))){ ?>
                                <a href="<?= base_url('penjualan_barang_konsinyasi/print_tunai') ?>" target="_blank" class="btn btn-warning btn-flat btn-block pull-right"><i class="fa fa-print"></i> Print</a>
                            <? }else{  ?>
                              <a href="<?= base_url('penjualan_barang_konsinyasi/print_tunai/') ?><?= $this->input->post('hari1') ?>/<?= $this->input->post('hari2') ?>/<?= $this->input->post('op') ?>" target="_blank" class="btn btn-warning btn-flat btn-block pull-right"><i class="fa fa-print"></i> Print</a> 
                            <? } ?>
                        </div>
                    </div>
                </div> 

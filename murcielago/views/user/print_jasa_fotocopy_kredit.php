...
<div class="container-fluid" style="height: 100%;">
    <section class="content-header h-h1">
        ...
        <div class="col-md-8">
          <h3 style="margin: 0px;" class="pull-left"><b>Jasa Fotocopy Print Kredit - Laporan Laba Rugi</b><br>
...
<!--                                    <td>Rp <?= number_format($p->satuan  * $p->harga_netto_jual_satuan - ($p->satuan * $cek_akhir_pem->harga_beli_satuan))?></td>-->
                    ...
                    $jasa_kredit = $this->m_data->cari_jasa_fotocopy_print_tunai($har1,$har2)->result();
                    ?>

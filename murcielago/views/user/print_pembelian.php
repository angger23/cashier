...
<!--
        <div class="col-md-3 img-logo">
            <img src="<?= base_url() ?>/assets_kasir/img/logo_stikes.png">
        </div>
-->
        <div class="col-md-9">
            <h1 class="img-logo">
...
-->
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-striped datatable-biasa">
                        ...
                        <tbody>
                            <? $no=0; foreach($pembelian_barang as $b){ $no++; ?>
                                <tr <? $date = date('Y-m-d'); if($date >= $b->tanggal_expired){echo'style="background-color:#f7d794;"';}elseif($b->jenis_barang == 'Makanan'){echo'style="background-color:#f7d794;"';}elseif($b->jenis_barang == 'Minuman'){echo'style="background-color:#f7d794;"';}else{} ?>>
                                    <td><?= $no ?></td>
                    ...
                    <?
                        ...
                        if(empty($har1) && empty($har2)){
                             $pembelian_barang = $this->m_data->cari_operator_pembelian($opt)->result();
                         }else{
                             $pembelian_barang = $this->m_data->cari_hari_pembelian($har1,$har2)->result();
                         }
                    ?>
                    ...
                    <table class="table table-bordered table-striped datatable-biasa">
                        ...
                        <tbody>
                            <? $no=0; foreach($pembelian_barang as $b){ $no++; ?>
                                <tr <? $date = date('Y-m-d'); if($date >= $b->tanggal_expired){echo'style="background-color:#ff7675;font-weight:500;"';}elseif($b->jenis_barang == 'Makanan'){echo'style="background-color:#ff7675;font-weight:500;"';}elseif($b->jenis_barang == 'Minuman'){echo'style="background-color:#ff7675;font-weight:500;"';}else{} ?>>
                                    <td><?= $no ?></td>
                                    <td><?= tgl_indo(date('Y-m-d', strtotime($b->tanggal_pembelian))) ?></td>
                                    <td></td>
                                    <td><?= $b->kode_supplier ?></td>

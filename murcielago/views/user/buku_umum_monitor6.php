                   ...
                   <table class="table table-bordered table-striped datatable">
                    ...
                    foreach($posts as $l){
                       ...
                       <?php } ?>
                         ...
                         <td>Rp. <? $salq =  $krex - $l->debit; echo number_format($salq,2)  ?></td>
                         <td>Rp. <?
                          if($no==1){
                             $sal= $salq;
                          }else{
                                 ...
                                 if($cari_next_kode){
                                  ...
                                  <form action="<?php echo base_url('buku_umum/update_'.strtolower($l->kode).'') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="tgl" class="form-control datepicker" id="tanggalku<?php echo $cari_next_kode->id_buku_umum ?>" value="<?php echo $l->tanggal ?>">
                                    </div>
                                    <div class="form-group">

...
<div class="container-fluid" style="height: 100%;">
    <section class="content-header h-h1">
        ...
        <div class="col-md-8">
          <h3 style="margin: 0px;" class="pull-left"><b>Penjualan Barang Toko Tunai - Laporan Laba Rugi</b><br>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $penjualan_toko_kredit = $this->m_data->cari_penjualan_belanja_barang($har1,$har2)->result();
                    ?>

                ...
                <div class="table table-responsive">
                   <table class="table table-bordered table-striped datatable">
                    ...
                    foreach($posts as $l){
                       ...
                       <?php } ?>
                         <td>Rp. <? $salq =  $l->kredit - $dex; echo number_format($salq,2)  ?></td>
                         <td>Rp. <?
                          if($no==1){
                             $sal= $salq;
                          }else{
                         ...
                         <div class="modal-dialog">
                           ...
                           <div class="modal-content">
                             <div class="modal-header">
                               ...
                               <h4 class="modal-title">Update Pengeluaran</h4>
                             </div>
                             <div class="modal-body">
                               <div class="form-group">
                                 ...
                                 if($cari_next_kode){
                                  ?>
                                  <form action="<?php echo base_url('buku_umum/update_'.strtolower($l->kode).'') ?>" method="post">
                                    <input type="hidden" name="book_um" value="<?php echo $cari_next_kode->id_buku_umum ?>">
                                    <div class="form-group">
                                      <label for="">Nominal Pengeluaran</label>
                                      <input type="text" class="form-control" name="nominal_pengeluaran" value="<?php echo $cari_next_kode->debit ?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                <?php }else{ ?>
                                 <form action="<?php echo base_url('buku_umum/add_'.strtolower($l->kode).'') ?>" method="post">
                  ...
                  <!-- </div> -->
                     ...
                     <table class="table table-bordered">
                       <tr style="background-color:#2c3e50;color:#fff;">
                         <td><b>Total</b></td>
                         <td> <b>Pemasukan (Kredit)</b> : Rp.&nbsp;<?= number_format($kredit,2) ?></td>
                         <td> <b>Pengeluaran (Debet)</b> : Rp.&nbsp;<?= number_format($debit,2) ?></td>
                         <td> <b>Saldo</b> : Rp.&nbsp; <?= number_format($kredit - $debit,2) ?></td>
                       </tr>
                     </table>
                 </div>
           </div>

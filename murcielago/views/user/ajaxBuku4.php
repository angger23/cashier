...
<div class="col-md-12">
  <?
    if(!empty($tgl)){
    ?>
    <a href="<?= base_url('bank_buku/cetak_buku1/'.$tgl.'/'.$tgl1.'/'.$id.'/STKT/kurang') ?>" target="_blank" class="btn btn-info btn-flat pull-right" type="button"><i class="fa fa-print"></i> Print</a>
    <? }else{ ?>
    <a href="<?= base_url('bank_buku/cetak_buku1/0/0/0/STKT/kurang') ?>" target="_blank" class="btn btn-info btn-flat pull-right" type="button" style="margin:5px;"><i class="fa fa-print"></i> Print</a>
    <? } ?>
    <?
    if(!empty($tgl)){
    ?>
    <a href="<?= base_url('bank_buku/export_buku1/'.$tgl.'/'.$tgl1.'/'.$id.'/STKT/kurang') ?>" class="btn btn-success btn-flat pull-right"><i class="fa fa-file-excel-o"></i> Export</a>
    <? }else{ ?>
    <a href="<?= base_url('bank_buku/export_buku1/0/0/0/STKT/kurang') ?>" class="btn btn-success btn-flat pull-right" style="margin:5px;"><i class="fa fa-file-excel-o"></i> Export</a>
    <? } ?>
    ...
    <table class="table table-bordered datatable-biasa3">
      ...
      <tbody>
        ...
        <tr>
          ...
          <? $salq = $l->kredit - $l->debit; //echo number_format($salq)  ?>

...
<div class="main" style="padding-bottom: 100px;">
	<div class="main-inner">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
                    <h3 style="margin: 0px;" class="pull-left"><b><i class="fa fa-stock"></i>&nbsp;&nbsp;Semua Penjualan Internal Toko - Laporan Laba Rugi</b></h3>
                </div>
            </div>  
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <? 
                  ...
                  $total1 = 0;
                  $total2 = 0;
                  foreach($penjualan_intern_all as $p):
                  $nos++;
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered datatable-biasa">
                              ...
                              <tbody>
                                <? $no = 0; foreach($penjualan_intern_all as $p){ $no++; ?>
                                  <tr>
                                    <td><?= $no ?></td>
                ...
                <? }else{  ?>
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered datatable-biasa">
                              ...
                              <tbody>
                                <? $no = 0; $penjualan_intern_all = $this->m_data->cari_penjualan_intern_all($hari1,$hari2)->result(); foreach($penjualan_intern_all as $p){ $no++; ?>
                                  <tr>
                                    <td><?= $no ?></td>
                                    <td><?= tgl_indo(date('Y-m-d',strtotime($p->tanggal_penjualan))); ?></td>
                                    <td><?= $p->kd_nota ?></td>
